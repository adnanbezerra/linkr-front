...
export default function DeletePost({ id, modalIsOpen, setIsOpen, setPosts, setEditMode, editMode }) {
    ...
    return (
        <Edit>
            <div>
                <BsFillPencilFill color="#FFFFFF" size={18} cursor='pointer' onClick={() => setEditMode(!editMode)} />
            </div>
            <div>
